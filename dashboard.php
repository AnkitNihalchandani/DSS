...
// Expense
$expsql="SELECT SUM(sm_e_amount) AS Totalexpense FROM sm_expense_detail";
$exresult=$conn->query($expsql);
$exrow=$exresult->fetch_assoc();
// Income
$incmsql="SELECT SUM(e_i_amount) AS Totalincome FROM extra_income";
$incomeresult=$conn->query($incmsql);
$incomerow=$incomeresult->fetch_assoc();
//notification
$compsql="SELECT SUM(sm_c_id) AS Totalcomp FROM sm_complaint where sm_u_status='1'";
$compresult=$conn->query($compsql);
$comprow=$compresult->fetch_assoc();
// wing
$wingsql="SELECT COUNT(w_id) AS Totalwing FROM sm_wing where w_status='1'";
$wingresult=$conn->query($wingsql);
$wingrow=$wingresult->fetch_assoc();

// member
$membersql="SELECT COUNT(u_id) AS Totaluser FROM sm_user where u_status='1'";
$memberresult=$conn->query($membersql);
$membergrow=$memberresult->fetch_assoc();
?>
<!DOCTYPE HTML>
<html>
<head>
<title>Digital Socitey Service| Home </title>
		...
		<div id="page-wrapper">
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong>Rs.<?php echo $exrow['Totalexpense'] ;?></strong></h5>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong>Rs.<?php echo $incomerow['Totalincome'] ;?></strong></h5>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong>Rs.<?php echo $comprow['Totalcomp'] ;?></strong></h5>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong><?php echo $wingrow['Totalwing'];?></strong></h5>
                      <span>Wing</span>
                    </div>
                </div>
        	 </div>
        	<div class="col-md-3 widget">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong><?php echo $membergrow['Totaluser'];?></strong></h5>
		...
		<div class="charts">		
			<div class="mid-content-top charts-grids">
				<div class="middle-content">
						<h4 class="title">Society Slider</h4>
					<!-- start content_slider -->
					<div id="owl-demo" class="owl-carousel text-center">
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="images/ss1.jpg" alt="name">
						</div>
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="images/ss2.jpg" alt="name">
						</div>
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="images/ss3.jpg" alt="name">
						</div>
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="images/ss4.jpg" alt="name">
						</div>
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="images/ss5.jpg" alt="name">
						</div>
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="images/ss6.jpg" alt="name">
						</div>
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="images/ss7.jpg" alt="name">
						</div>
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="images/ss8.jpg" alt="name">
						</div>
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="images/ss9.jpg" alt="name">
						</div>
