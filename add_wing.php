...
<html>
<head>
<title>Digital Socitey Service | Add Wing </title>
...
<body class="cbp-spmenu-push">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<h2 class="title1" style="margin-top:70px;">Add Wing</h2>
				<p style="color:red;">
					<?php  
						if(isset($_GET['msg']))
						{
				...
				<div class="blank-page widget-shadow scroll" id="style-2 div1">
						...
						<div class="form-body">
							...
							<form action="" method="post"> 
								<div class="form-group">
									<label for="inputPassword" class="col-sm-2 control-label">Wing Name</label>
									<div class="col-sm-8">
					...
					<form action="" method="post"> 
								<div class="form-group">
									<label for="inputPassword" class="col-sm-2 control-label">Wing Name</label>
									<div class="col-sm-8">
										<input type="text" name="wing_name" class="form-control1" id="inputPassword" placeholder="Enter Wing Name" required>
									</div>
								</div>
								<div class="clearfix"></div>
								<br>
								...
								<div class="clearfix"></div>
								<br>
							  <input type="submit" name="add_wing" value="Add Wing"  class="btn btn-primary"> 
								</form> 
